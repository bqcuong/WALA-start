...
import com.ibm.wala.examples.analysis.dataflow.MyContextSensitiveReachingDefs;
...
/**
 * Driver for running {@link MyContextSensitiveReachingDefs}
 */
public class CSReachingDefsDriver {
    ...
    public static void main(String[] args) throws IOException, ClassHierarchyException, IllegalArgumentException, CallGraphBuilderCancelException {
        ...
        scope.setExclusions(new FileOfClasses(new FileInputStream("./example/Java60RegressionExclusions.txt")));
...
//	    System.out.println(cg);
        ...
        MyContextSensitiveReachingDefs reachingDefs = new MyContextSensitiveReachingDefs(cg);
        System.out.println("analyzing reaching defs...");
